      ...
      <div className={styles.pageInterior}>
        <section className={styles.scrollSection}>
          ...
          <article className={styles.content}>
            ...
            <p>
              My time at eBay has given me a wealth of new and unexpected experiences, and a deepened appreciation for the challenges of engineering at scale. I look forward to carrying these lessons forward into my next role and beyond.
            </p>
          </article>
        </section>
