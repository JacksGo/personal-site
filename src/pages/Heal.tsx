      ...
      <div className={styles.pageInterior}>
        <section className={styles.scrollSection}>
          ...
          <article className={styles.content}>
            <p>
              Heal is a Los Angeles-based startup that provides in-home healthcare, telemedicine, and remote patient monitoring services to Medicare patients in eight states across the country.
            </p>
            <p>
